...
4468:  0e43           clr	r14
446a:  0b3c           jmp	$+0x18 <printf+0x3a>
446c:  1f53           inc	r15
446e:  7d90 2500      cmp.b	#0x25, r13
4472:  0720           jnz	$+0x10 <printf+0x3a>
4474:  6d9f           cmp.b	@r15, r13
4476:  0320           jnz	$+0x8 <printf+0x36>
4478:  1f53           inc	r15
447a:  0d43           clr	r13
447c:  013c           jmp	$+0x4 <printf+0x38>
447e:  1d43           mov	#0x1, r13
4480:  0e5d           add	r13, r14
4482:  6d4f           mov.b	@r15, r13
4484:  4d93           tst.b	r13
4486:  f223           jnz	$-0x1a <printf+0x24>
...
44f0:  4f93           tst.b	r15
44f2:  f823           jnz	$-0xe <printf+0x9c>
44f4:  273c           jmp	$+0x50 <printf+0xfc>
44f6:  7e90 7800      cmp.b	#0x78, r14
44fa:  1e20           jnz	$+0x3e <printf+0xf0>
44fc:  2b49           mov	@r9, r11
44fe:  2742           mov	#0x4, r7
4500:  163c           jmp	$+0x2e <printf+0xe6>
...
4516:  0338           jl	$+0x8 <printf+0xd6>
4518:  3f50 3000      add	#0x30, r15
451c:  023c           jmp	$+0x6 <printf+0xda>
...
4532:  e723           jnz	$-0x30 <printf+0xba>
4534:  2a52           add	#0x4, r10
4536:  063c           jmp	$+0xe <printf+0xfc>
4538:  7e90 6e00      cmp.b	#0x6e, r14
453c:  0320           jnz	$+0x8 <printf+0xfc>
...
454c:  4f93           tst.b	r15
454e:  b123           jnz	$-0x9c <printf+0x6a>
...
4572:  635d           add.b	@r13, 4
4574:  205b           add	@r11, pc
4576:  7020           jnz	$+0xe2 <walk+0x9e>
4578:  2578           subc	@r8, r5
457a:  5d20           jnz	$+0xbc <walk+0x7c>
457c:  5b6e 2025      addc.b	0x2520(r14), r11
4580:  785d           add.b	@r13+, r8
4582:  205b           add	@r11, pc
4584:  7320           jnz	$+0xe8 <walk+0xb2>
4586:  2578           subc	@r8, r5
4588:  5d0a 0020      push.b	0x2000(r13)
458a:  0020           jnz	$+0x2 <printf+0x144>
458c:  7b25           jz	$+0x2f8 <add_to_table+0x52>
458e:  787d           subc.b	@r13+, r8
4590:  205b           add	@r11, pc
4592:  2000           rrc	@pc
4594:  2578           subc	@r8, r5
4596:  2000           rrc	@pc
4598:  4025           jz	$+0x282 <hash+0xc>
459a:  7820           jnz	$+0xf2 <malloc+0x14>
459c:  5b66 7265      addc.b	0x6572(r6), r11
45a0:  6564           addc.b	@r4, r5
45a2:  5d20           jnz	$+0xbc <walk+0xa4>
45a4:  5b70 2025      subc.b	0x2520(pc), r11
45a8:  785d           add.b	@r13+, r8
45aa:  205b           add	@r11, pc
45ac:  6e20           jnz	$+0xde <malloc+0x12>
45ae:  2578           subc	@r8, r5
45b0:  5d20           jnz	$+0xbc <walk+0xb2>
45b2:  5b73           subc.b	#0x1, r11
45b4:  2025           jz	$+0x242 <create_hash_table+0x7e>
...
47a2:  0f93           tst	r15
47a4:  0324           jz	$+0x8 <create_hash_table+0x34>
47a6:  0b5b           add	r11, r11
47a8:  1f83           dec	r15
47aa:  fd23           jnz	$-0x4 <create_hash_table+0x2e>
...
47c2:  0793           tst	r7
47c4:  0324           jz	$+0x8 <create_hash_table+0x54>
47c6:  0858           add	r8, r8
47c8:  1783           dec	r7
47ca:  fd23           jnz	$-0x4 <create_hash_table+0x4e>
...
47d8:  0943           clr	r9
47da:  0f3c           jmp	$+0x20 <create_hash_table+0x82>
47dc:  0749           mov	r9, r7
47de:  0757           add	r7, r7
...
47f8:  1953           inc	r9
47fa:  0998           cmp	r8, r9
47fc:  ef3b           jl	$-0x20 <create_hash_table+0x64>
...
487a:  0e93           tst	r14
487c:  0324           jz	$+0x8 <add_to_table+0x52>
...
48fe:  0e93           tst	r14
4900:  0324           jz	$+0x8 <rehash+0x34>
4902:  0a5a           add	r10, r10
4904:  1e83           dec	r14
4906:  fd23           jnz	$-0x4 <rehash+0x2e>
...
4920:  173c           jmp	$+0x30 <rehash+0x7c>
...
4956:  0d93           tst	r13
4958:  0324           jz	$+0x8 <rehash+0x8c>
495a:  0e5e           add	r14, r14
495c:  1d83           dec	r13
495e:  fd23           jnz	$-0x4 <rehash+0x86>
4960:  0a9e           cmp	r14, r10
4962:  df3b           jl	$-0x40 <rehash+0x4e>
4964:  0f46           mov	r6, r15
4966:  1e43           mov	#0x1, r14
4968:  0f93           tst	r15
496a:  0324           jz	$+0x8 <rehash+0x9e>
496c:  0e5e           add	r14, r14
496e:  1f83           dec	r15
4970:  fd23           jnz	$-0x4 <rehash+0x98>
4972:  814e 0000      mov	r14, 0x0(sp)
4976:  0a45           mov	r5, r10
4978:  0944           mov	r4, r9
497a:  0743           clr	r7
497c:  153c           jmp	$+0x2c <rehash+0xd4>
...
4992:  023c           jmp	$+0x6 <rehash+0xc4>
4994:  0843           clr	r8
4996:  0648           mov	r8, r6
4998:  2699           cmp	@r9, r6
499a:  f13b           jl	$-0x1c <rehash+0xaa>
...
49e8:  0d93           tst	r13
49ea:  0324           jz	$+0x8 <get_from_table+0x26>
49ec:  0b5b           add	r11, r11
49ee:  1d83           dec	r13
49f0:  fd23           jnz	$-0x4 <get_from_table+0x20>
...
4a00:  0843           clr	r8
4a02:  0d3c           jmp	$+0x1c <get_from_table+0x52>
4a04:  0749           mov	r9, r7
...
4a12:  0f93           tst	r15
4a14:  0320           jnz	$+0x8 <get_from_table+0x50>
4a16:  1f47 1000      mov	0x10(r7), r15
4a1a:  073c           jmp	$+0x10 <get_from_table+0x5e>
4a1c:  1853           inc	r8
4a1e:  1f4a 0800      mov	0x8(r10), r15
4a22:  0f5b           add	r11, r15
4a24:  289f           cmp	@r15, r8
4a26:  ee3b           jl	$-0x22 <get_from_table+0x38>
...
4a5c:  6361           addc.b	@sp, 4
4a5e:  6e20           jnz	$+0xde <get_from_table+0x170>
...
4ae2:  7373           subc.b	#-0x1, 4
4ae4:  2064           addc	@r4, pc
4ae6:  656e           addc.b	@r14, r5
4ae8:  6965           addc.b	@r5, r9
4aea:  6400           rrc.b	@r4
4aec:  4361           addc.b	sp, 4
4aee:  6e20           jnz	$+0xde <run+0x66>
4af0:  6e6f           addc.b	@r15, r14
4af2:  7420           jnz	$+0xea <run+0x76>
...
4d7a:  3041           ret
4d7c <strcmp>
4d7c:  033c           jmp	$+0x8 <strcmp+0x8>
4d7e:  4d93           tst.b	r13
4d80:  0b24           jz	$+0x18 <strcmp+0x1c>
4d82:  1f53           inc	r15
4d84:  6d4f           mov.b	@r15, r13
4d86:  6c4e           mov.b	@r14, r12
4d88:  1e53           inc	r14
4d8a:  4d9c           cmp.b	r12, r13
4d8c:  f827           jz	$-0xe <strcmp+0x2>
