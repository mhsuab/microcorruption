...
4446:  fd3f           jmp	$-0x4 <__stop_progExec__+0x0>
4448 <__ctors_end>
...
44f4:  f923           jnz	$-0xc <set_up_protection+0xa>       ; goto 44e8
44f6:  0f4b           mov	r11, r15
44f8:  b012 b444      call	#0x44b4 <mark_page_executable>
44fc:  1b53           inc	r11
44fe:  3b90 0001      cmp	#0x100, r11
4502:  f923           jnz	$-0xc <set_up_protection+0x18>       ; goto 44f6
...
452c:  b012 6244      call	#0x4462 <getsn>         ; gets(sp, 0x30)
