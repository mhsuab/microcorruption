...
4454:  0412           push	r4                  ; save r4
4456:  0441           mov	sp, r4              ; r4 = sp
4458:  2453           incd	r4                  ; r4 = sp + 2
445a:  2183           decd	sp;                 ; sp = sp - 2
445c:  c443 fcff      mov.b	#0x0, -0x4(r4)      ; [r4 - 4] = 0
4460:  3e40 fcff      mov	#0xfffc, r14        ; r14 = 0xfffc = -4
4464:  0e54           add	r4, r14             ; r14 = r4 - 4
4466:  0e12           push	r14
4468:  0f12           push	r15
...
455a:  f290 fb00 1024 cmp.b	#0xfb, &0x2410                  ; only check for [input + 0x10] == 0xfb
